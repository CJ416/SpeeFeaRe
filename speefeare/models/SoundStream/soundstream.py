...
from speefeare.models.SoundStream.vq.layers import CausalConv1d
from speefeare.models.SoundStream.vq.layers import CausalConvTranspose1d
from speefeare.models.SoundStream.vq.quantize import ResidualVectorQuantize
...
class ResidualUnit(nn.Module):
    def __init__(self, dim: int = 16, dilation: int = 1):
        ...
        self.block = nn.Sequential(
            nn.ELU(),
            CausalConv1d(dim, dim, kernel_size=7, dilation=dilation),
            nn.ELU(),
...
class Encoder(nn.Module):
    def __init__(
        ...
        self.block += [
            nn.ELU(),
            nn.Conv1d(d_model, d_latent, kernel_size=3),
        ]
