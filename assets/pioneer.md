# Pioneer works on Neural Audio Codec
...
Encodec adopts the architecture like SoundStream, following the Encoder-quantizer-Decoder paradigm.

- SEANet-based encoder and decoder

- LSTM capture local sequential dependency.

- Codebook is updated in EMA manner, not optimized through codebook loss and commitment loss

- Subtle difference in the discriminators

## DAC (Descript-inc---2023)
